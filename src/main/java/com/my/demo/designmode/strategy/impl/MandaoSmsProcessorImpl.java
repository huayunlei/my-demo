 ...
 */
@Service
public class MandaoSmsProcessorImpl extends AbstractSmsProcessor {
    @Override
    public void process(SmsParamDTO<?> smsParamDTO) {
        System.out.println("mandao..." + smsParamDTO.getSpCode());
    }

    @Override
    protected SmsProcessorRegister.SmsKeyPair getKayPair() {
        return new SmsProcessorRegister.SmsKeyPair(SpEnum.MANDAO.getCode());
    }
}
